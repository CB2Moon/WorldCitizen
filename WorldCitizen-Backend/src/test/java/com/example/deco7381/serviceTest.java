...
public class serviceTest {
    ...
    @Test
    public void test11(){
        hobbiesService.addHobbies("46725809","Novel");
    }
    ...
    @Test
    public void test14(){
        channelPostsService.addPost("46725809","DailyLife","I haven't played basketball for a long time. Can someone play basketball with me?");
    }
    ...
    public void test16(){
        ...
        String path=applicationHome.getDir().getParentFile().getParentFile().getAbsoluteFile()+"\\src\\main\\resources\\static\\img";
